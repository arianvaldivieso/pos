...
function get_suspended_sales_manage_table($items,$controller)
{
	...
	$table.='</tbody></table>';
	$table.='<script type="text/javascript">$(document).ready(function(){$("#dTable").dataTable({"sPaginationType": "bootstrap","bSort" : false,"language": {"zeroRecords": "'.lang('common_not_found').'"}});});</script>';
	return $table;
}
