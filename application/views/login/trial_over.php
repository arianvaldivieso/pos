            ...
            <div class="front">
                ...
                <div class="holder">
					...
					<?php echo lang('login_trial_over'); ?>
						...
						<a class="btn btn-block btn-sm btn-danger" href="https://POS-STORE.com/update_billing.php?store_username=<?php echo $cloud_customer_info['username'];?>" target="_blank"><?php echo lang('login_activate');?></a>
				</div>
			</div>
		</div>
	</div>
