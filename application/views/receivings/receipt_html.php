...
<tr>
	<td style="border-bottom:1px dashed #000000;">&nbsp;</td>
            ...
            <?php } ?>
                ...
                <td align="right" style="border-bottom:1px dashed #000000;"><?php echo to_quantity($item->quantity); ?></td>

            <?php if (!$this->config->item('hide_all_prices_on_recv')) { ?>
                <?php if($discount_exists) { ?>
                    
                        <td align="right" style="border-bottom:1px dashed #000000;"><?php echo to_quantity($item->discount); ?></td>
                    
                <?php } ?>
                
                    <td align="right" style="border-bottom:1px dashed #000000;">
...
<!-- tax start -->
    ...
    if (!$this->config->item('hide_all_prices_on_recv')) {
        ...
        <?php if(isset($amount_change)) { ?>
            <tr>
                ...
                <td align="right">
                    <?php echo to_currency($amount_tendered); ?>
                </td>
            </tr>
    ...
    <?php if (isset($supplier_balance_for_sale) && (double)$supplier_balance_for_sale && !$this->config->item('hide_store_account_balance_on_receipt')) {?>
        ...
        <tr>
            ...
            <td align="right">
                <?php echo to_currency($supplier_balance_for_sale); ?>
            </td>
        </tr>
    <?php
    }
