		...
		<div class="col-md-12">
			<div class="panel">
				<div class="panel-body">
					<h3 style="margin-left: 80px;"><a href="http://POS-STORE.com/buy_additional.php" target="_blank"><?php echo lang('locations_purchase_additional_licenses'); ?> &raquo;</a></h3>
			...
			<div class="col-md-12">				
				<div class="panel panel-piluku">
					...
					<div class="form-group">	
						...
						<div class="form-group">
							<?php echo form_label("<a href='https://POS-STORE.com/mercury_activate.php' target='_blank'>".lang('locations_enable_credit_card_processing').'</a>:', 'enable_credit_card_processing',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label'), FALSE); ?>
							<div class="col-sm-9 col-md-9 col-lg-10">
