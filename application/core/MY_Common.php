...
function is_on_phppos_host()
{
	...
	return isset($_SERVER['HTTP_HOST']) && (strpos($_SERVER['HTTP_HOST'],'POS-STORE.com') !== FALSE || strpos($_SERVER['HTTP_HOST'],'phppos.com') !== FALSE || strpos($_SERVER['HTTP_HOST'],'phppointofsalestaging.com') !== FALSE);
}
