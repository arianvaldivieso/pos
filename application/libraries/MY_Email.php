...
class MY_Email extends CI_Email 
{
	...
	{
		$CI =& get_instance();
		$this->from($CI->Location->get_info_for_key('email') ? $CI->Location->get_info_for_key('email') : 'no-reply@mg.POS-STORE.com', $CI->config->item('company'));
		$this->to($email); 
	...
	public function from($from, $name = '', $return_path = NULL)
	{
		...
		if (is_on_phppos_host())
		{
			...
			$from = 'no-reply@mg.POS-STORE.com';
		}
